...
$
Set $B_infinity = sect.big_(k=1)^(infinity) B_k$ , then
$
mu(RR^n without B_infinity) &= mu(RR^n without sect.big_(k=1)^(infinity)B_k) \
...
$
lim_(r arrow.br 0) (cal(L)^n (E sect BB_r(x))) / (cal(L)^n (BB_r(x))) =: Theta_E (x) in L^1_("loc")(RR^n, cal(L)^n) .
$
...
$
(cal(L)^n (BB_r (x) sect {abs(f - L) >= epsilon})) / (cal(L)^n (BB_r (x))) -> 0 quad "as" r -> 0^+
$
...
$
(cal(L)^n (BB_r (x) sect {abs(f - L) >= epsilon})) / (cal(L)^n (BB_r (x))) -> 0 ,
$
$
(cal(L)^n (BB_r (x) sect {abs(f - L') >= epsilon})) / (cal(L)^n (BB_r (x))) -> 0 .
$
