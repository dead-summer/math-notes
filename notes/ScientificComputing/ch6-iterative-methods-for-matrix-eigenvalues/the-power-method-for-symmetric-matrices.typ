...
$ upright(bold(v))_i^(upright(T)) upright(bold(v))_j = 0 "if" i eq.not j quad "and" quad norm(upright(bold(v))_j)_2 = 1 quad "for" j = 1 , 2 , dots.h.c , n . $
...
is equal to one and its first modulus-maximum entry has positive sign. From (11), we get
...
$ abs(mu_k - lambda_1) lt.eq C abs(lambda_2 / lambda_1)^(2 k) abs(lambda_2) $<eq:13>
...
$ phi^(') (xi)\|_(xi = 0) = frac(2 upright(bold(w))^(upright(T)) upright(bold(A x)) dot.op upright(bold(x))^(upright(T)) upright(bold(x)) - 2 upright(bold(w))^(upright(T)) upright(bold(x)) dot.op upright(bold(x))^(upright(T)) upright(bold(A x)), (upright(bold(x))^(upright(T)) upright(bold(x)))^2) = upright(bold(w))^(upright(T)) nabla r (upright(bold(x))) . $
...
is the gradient of the Rayleight quotient $r (upright(bold(x)))$ .
...
$ nabla r (upright(bold(v))_j) = 0 quad "and" quad r (upright(bold(v))_j) = lambda_j quad "for" j = 1 , 2 , dots.h.c , n . $
...
&= r (upright(bold(v))_1) + 1 / 2 (upright(bold(x))_k - upright(bold(v))_1)^(upright(T)) upright(bold(H)) (upright(bold(x))_k - upright(bold(v))_1) + dots.h.c ,
$<eq:15>
...
$ abs(mu_k - lambda_1) lt.eq C norm(upright(bold(x))_k - upright(bold(v))_1)^2 quad "for large" k , $<eq:16>
